...
1. Read `helpers/eod-report.md` for format rules, voice rules, and working sequence.
2. Read `projects/mediquant/eod-report.context.md` for project context (workstreams, stakeholders, acronyms).
3. Read `projects/mediquant/eod-report.previous.md` for yesterday's snapshot (slippage detection).
4. Read `projects/mediquant/client-email-template.html` for the HTML email template.
...
- Update `projects/mediquant/eod-report.previous.md` with today's snapshot
